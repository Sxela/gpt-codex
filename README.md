...
4. Watch the live stats panel for average/min/max speed, acceleration, and mass across all particles, plus inline charts that
   plot how each metric evolves over time.
